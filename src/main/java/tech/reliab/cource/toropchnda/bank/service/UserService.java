...
public interface UserService {
    ...
    /**
     * Сохраняет все счета пользователя по банку в файл(txt)
     */
    UserAccountsModel saveAllUsersAccountsByBankInFile(User user, Bank bank, String fileName) throws IOException;
